...
for config in configs:
    ...
    for video_id in video_ids:
        ...
        track_means = valid_data.groupby("track_id")["max_feret_diameter"].mean()
...
ax.set_ylabel("Mean max mefet", fontsize=12)
ax.set_title("Mean max feret per Object by Group", fontsize=14)
ax.grid(axis="y", alpha=0.3, linestyle="--")

plt.tight_layout()
plt.savefig("feret_boxplot_objects.png", dpi=150)
plt.close()

loginfo("\nSaved: feret_boxplot_objects.png")
loginfo("Done!")
